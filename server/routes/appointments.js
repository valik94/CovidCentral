...
module.exports = (db) => {
  router.post("/", (req, res) => {
    ...
    const { startAt, endAt, summary, color, notification_sent, patient_id } =
      req.body; //getting information from FORM that is sent from frontend

    console.log("REQ BODY");
    const bookAppointments = function (
      startAt,
      endAt,
      summary,
      color,
      ...
      const appointments = db.query(
        `INSERT INTO appointments ("startAt", "endAt", summary, color, notification_sent, patient_id, practitioner_id)
      ...
      const patientBasedOnId = db.query(
